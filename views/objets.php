...
<body>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link active" href="<?= base_url()?>Home/gestion_objet">Vos Objet</a></li>
  ...
  <section id="Proposition" class="portfolio">
      <div class="container" data-aos="">
                ...
                <?php
                    foreach ($objets as $objet) {
                        ...
                        <div class="card" style="width: 18rem;">
                            <img src="<?= $objet['path']?>" class="card-img-top" alt="...">
                            <div class="card-body">
                                <h5 class="card-title"><?= $objet['nom']?></h5>
                                <p>Prix Estimatif : <?= $objet['prixestimatif']?></p>
                                <p class="card-text"><?= $objet['description']?></p>
                                <p></p>
                                <a href="#" class="btn btn-outline-info"><i class="bi bi-cash-stack"></i> +/- 10 %</a>
                                <a href="#" class="btn btn-outline-info"><i class="bi bi-cash-stack"></i> +/- 20 %</a>
                            </div>
                        </div>
                        </div>
                        <?php
        ...
        <div class="container">
            <a href="<?= base_url()?>home/ajout" class="btn btn-outline-success"><i class="bi bi-plus-circle"></i> Ajouter</a>
        </div>
