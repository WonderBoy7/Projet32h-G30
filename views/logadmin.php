...
<div class="login_form">
  <h2>admin</h2>
  <form action="<?= base_url()?>Welcome/check/true" method="post">
    <input type="text" name="email" class="email" placeholder="Email" value="ard.tolotra@gmail.com">
    <br/>
    <input type="password" name="pwd" class="pwd" placeholder="Mot de passe" value="123root123">
    <p class="mssg"> Vous n'avez pas encore de compte?
      <a href="" class="link">
        S'inscrire
      </a>
    </p>
    <p class="mssg"> Se connecter en tant qu' 
      <a href="<?= base_url()?>Welcome/admin" class="link">
        Administrateur
      </a>
    </p>
    <br/>
