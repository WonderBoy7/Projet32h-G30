...
<body>
  ...
  <header id="header" class="header-inner-pages">
    <div class="container d-flex align-items-center">
      ...
      <ul>
          <li><a class="nav-link" href="<?= base_url()?>">Accueil</a></li>
          <li><a class="nav-link " href="<?= base_url()?>Home/gestion_objet">Vos Objet</a></li>
          <li><a class="nav-link active" href="<?= base_url()?>Home/all_objet">Liste objet</a></li>
...
<style type="text/css">
  ...
  margin-left:-80px;
    ...
    <div id="h" class="col-md-10 col-lg-4 col-xl-4 mx-auto position-relative">
        <form action="<?=base_url()?>Home/search" method="post"> <center>
            <div class="row">
                <div id="k" class=" col-md-1 col-md-9 "><input class="form-control form-control-lg" type="text" name="keysearch" placeholder="Recherchez"></div>
                <div id="o"  class="col-md-14 col-md-7 ">
                    <form method="post">
                        <div class="illustration"></div><select name="catego" class="form-control form-control-lg" >
                          <option value="*">Tous</option>
                        <?php
                              foreach ($all as $catego) {
                                ?>
                                <option value="<?=$catego['id']?>"><?=$catego['nom']?></option>
                                <?php
                              }
                            ?>
                        ...
                        <div class="col-12 col-md-2" ><button class="btn btn-primary btn-lg" type="submit"><i class="bi bi-search"></i></button></div>
            </center></div>
        </form>
    </div>
              ...
              ?>
                <div class="col-lg-4 col-md-6 portfolio-item filter-<?= $objet['idcatego']?>">
                  ...
                  <div class="portfolio-info">
                    ...
                    <a href="<?= base_url()?>Home/history/<?= $objet['idobjet']?>" class="preview-link" title=""><i class="bi bi-clock-history"></i></a>
