...
<body>
  ...
  <header id="header" class="header-inner-pages">
    <div class="container d-flex align-items-center">
      ...
      <ul>
          ...
          <li><a class="nav-link active" href="<?= base_url()?>Home/proposition">Proposition</a></li>
  ...
  <section id="Proposition" class="portfolio">
      <div class="container" data-aos="">
        ...
        <div class="container">
          <?php
            foreach ($propos as $proposition) {
              ?>
                <div class="row">
                    <div class="col">
                      <input type="hidden" name="idpropos" value="">
                        <div class="card" style="width: 18rem;">
                        <div class="container">
                            <div class="row">
                                <div class="col"><img src="<?= base_url()?>assets/img/portfolio/portfolio-1.jpg" class="card-img-top" alt="..."></div>
                            </div>
                            <div class="row">
                                <div class="col"><img src="<?= base_url()?>assets/img/portfolio/portfolio-1.jpg" class="card-img-top" alt="..."></div>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <a href="<?=base_url()?>Statics/accepter/<?=$proposition['id']?>" class="btn btn-outline-success"><i class="bi bi-check-square-fill"></i> Accepter</a>
                                <a href="<?=base_url()?>Statics/refuser" class="btn btn-outline-danger"><i class="bi bi-x-square-fill"></i> Refuser</a>
                            </div>
                        </div>
                    </div>
                </div>
