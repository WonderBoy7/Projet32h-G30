...
<head>
  ...
  <title>Statistique de la plateforme</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="<?= base_url()?>assets/img/accueil.png" rel="icon">
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link active" href="<?= base_url()?>admin/statistique">Statistique</a></li>
  ...
  <section id="Proposition" class="portfolio">
      <div class="container" data-aos="">
        <div class="section-title">
          <h2>Statistique de la Plateforme</h2>
          <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Facilis veniam natus veritatis nostrum laborum. Dicta sapiente fuga similique tempore, ducimus delectus impedit, reiciendis ipsa dolores aliquam, explicabo laborum qui ut?</p>
        </div>
            
        <p class="section-grid">
            <h4>Nombre d'utilisateur actuel : </h4><span><?=$size?></span>
            <h4>Nombre d'échange éffectué : </h4><span><?=$nbr?></span>
        </p>
      </div>
