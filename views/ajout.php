...
<body>
  ...
  <div class="container" data-aos="">
        ...
        <form action="<?= base_url()?>Home/ajouter" method="post" enctype="multipart/form-data">
            <input type="hidden" name="object" value="1">
            <div class="form">
                <div class="mb-3 row">
                    <label for="" class="col-sm-2 col-form-label">Catégorie</label>
                    <div class="col-sm-10">
                      <select name="catego" class="form-select" id="">
                          <?php
                ...
                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">Prix Estimatif</label>
                    <input type="number" name="prix" class="form-control" id="" placeholder="0.00">
                </div>
                <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">Image</label>
                    <input type="file" name="userfile" class="form-control" id="" placeholder="Importer image">
                </div>
            </div>
